...
@ComponentScan("com.vironit.airticketsbooking.springapp.config")
...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.vironit.airticketsbooking.springapp.entity" });
